...
public class ArrayListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new Item("this is my first Item", R.drawable.photo, true, 50));
        list.add(new Item("this is my second Item", R.drawable.phototwo, true, 60));
        list.add(new Item("this is my third Item", R.drawable.ic_launcher_background, true, 50));
